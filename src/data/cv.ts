...
export const experience: ExperienceType = [
  {
    ...
    detail: `I'm currently working in the migration from SAP ECC to SAP S/4HANA project at
  ...
  },
  {
    ...
    detail: `I focused on coordinating project planning with the functional team,
  ...
  },
  {
    ...
    detail: `Code adaptations for S4 and performance
    improvements, post go-live support and bug fixing.
    I created a tool to automate the dual maintenance
  ...
  },
  {
    ...
    link: "",
    detail: `Code adaptations for S/4 and performance improvements,
    post go-live support, and bug fixing. Manual tasks include
    importing transport requests from ECC to S/4 to ensure
    consistency between systems during the migration.`,
  },
  {
    ...
    detail: `As an ABAP Lead for the Argentine development team,
    I coordinated various custom developments for the project and reported back
    to the Peru team on the progress and outcomes of the Argentine team's work.
    The developments I led included electronic billing development for
    Alicorp Mexico, H2R developments for Ecuador and Honduras,
    and R2R developments primarily for Peru.`,
  },
  {
  ...
  },
  {
    ...
    link: "",
    detail: `Maintained, enhanced, and troubleshooted ABAP programs and objects within the SAP system.
  ...
  },
  {
    ...
    detail: `Resolution of tickets, system bug fixes, new developments requested by customers. All
